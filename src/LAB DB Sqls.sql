...
CREATE TABLE LAB_BRANCH_REP(LAB_REP_ID INT(16)  AUTO_INCREMENT PRIMARY KEY,PRIM_MOBILE   VARCHAR(16),REP_NAME VARCHAR(100),LAB_BRANCH_CD INT(16), FOREIGN KEY(LAB_BRANCH_CD) REFERENCES LAB_BRANCH(LAB_BRANCH_CD),STATUS   VARCHAR(25));